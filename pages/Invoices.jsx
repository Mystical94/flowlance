      ...
      <Popup />
        ...
        <form action="" className={invoice.form}>
          ...
          <select id="cars" name="cars" onChange={(e) => setInvobj(prevInv => {
            ...
            <option value='Flowlancer Client 1'>Flowlancer Client 1</option>
            <option value='Flowlancer Client 2'>Flowlancer Client 2</option>
            <option value='Flowlancer Client 3'>Flowlancer Client 3</option>
          </select> <br />
          <label htmlFor="">Work Description:</label> <br />
          {/* <input type="text" /> <br /> */}
          <textarea
           name="" 
           id="" 
           cols="50" 
           rows="10" 
           placeholder="Service description - from: (starting date) to: (ending date)."
          ...
          required
          /> <br />
          <label htmlFor="">Total Working Hours:</label>
          <input
           type="number"
           min="1"
           onChange={(e) => setInvobj(prevInv => {
          ...
          required 
          /> <br />
          <label htmlFor="">Total payment in USD:</label>
          <input
           type="number"
           min="1"
           onChange={(e) => setInvobj(prevInv => {
